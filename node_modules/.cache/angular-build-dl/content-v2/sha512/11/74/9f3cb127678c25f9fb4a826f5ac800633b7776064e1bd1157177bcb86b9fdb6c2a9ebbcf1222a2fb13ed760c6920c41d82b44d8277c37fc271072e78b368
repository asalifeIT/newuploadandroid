...
const routes = [
    ...
    {
        path: 'register',
        loadChildren: () => Promise.resolve(/*! import() */).then(__webpack_require__.bind(null, /*! ./register/register.module */ "./src/app/register/register.module.ts")).then(m => m.RegisterPageModule)
    },
    {
        path: 'catering',
        loadChildren: () => __webpack_require__.e(/*! import() | catering-catering-module */ "catering-catering-module").then(__webpack_require__.bind(null, /*! ./catering/catering.module */ "./src/app/catering/catering.module.ts")).then(m => m.CateringPageModule)
    },
    {
        path: 'ratingcatering',
        loadChildren: () => __webpack_require__.e(/*! import() | ratingcatering-ratingcatering-module */ "ratingcatering-ratingcatering-module").then(__webpack_require__.bind(null, /*! ./ratingcatering/ratingcatering.module */ "./src/app/ratingcatering/ratingcatering.module.ts")).then(m => m.RatingcateringPageModule)
    },
    {
        path: 'aduanhk',
        loadChildren: () => Promise.all(/*! import() | aduanhk-aduanhk-module */[__webpack_require__.e("default~aduancatering-aduancatering-module~aduanhk-aduanhk-module~aduanlaundry-aduanlaundry-module"), __webpack_require__.e("aduanhk-aduanhk-module")]).then(__webpack_require__.bind(null, /*! ./aduanhk/aduanhk.module */ "./src/app/aduanhk/aduanhk.module.ts")).then(m => m.AduanhkPageModule)
    },
    {
        path: 'ratinghk',
        loadChildren: () => __webpack_require__.e(/*! import() | ratinghk-ratinghk-module */ "ratinghk-ratinghk-module").then(__webpack_require__.bind(null, /*! ./ratinghk/ratinghk.module */ "./src/app/ratinghk/ratinghk.module.ts")).then(m => m.RatinghkPageModule)
    },
    {
        path: 'aduanlaundry',
        loadChildren: () => Promise.all(/*! import() | aduanlaundry-aduanlaundry-module */[__webpack_require__.e("default~aduancatering-aduancatering-module~aduanhk-aduanhk-module~aduanlaundry-aduanlaundry-module"), __webpack_require__.e("aduanlaundry-aduanlaundry-module")]).then(__webpack_require__.bind(null, /*! ./aduanlaundry/aduanlaundry.module */ "./src/app/aduanlaundry/aduanlaundry.module.ts")).then(m => m.AduanlaundryPageModule)
    },
    {
        path: 'aduanmaintenance',
        loadChildren: () => __webpack_require__.e(/*! import() | aduanmaintenance-aduanmaintenance-module */ "aduanmaintenance-aduanmaintenance-module").then(__webpack_require__.bind(null, /*! ./aduanmaintenance/aduanmaintenance.module */ "./src/app/aduanmaintenance/aduanmaintenance.module.ts")).then(m => m.AduanmaintenancePageModule)
    },
    {
        path: 'ratingmaintenance',
        loadChildren: () => __webpack_require__.e(/*! import() | ratingmaintenance-ratingmaintenance-module */ "ratingmaintenance-ratingmaintenance-module").then(__webpack_require__.bind(null, /*! ./ratingmaintenance/ratingmaintenance.module */ "./src/app/ratingmaintenance/ratingmaintenance.module.ts")).then(m => m.RatingmaintenancePageModule)
    },
    {
        path: 'aduancatering',
        loadChildren: () => Promise.all(/*! import() | aduancatering-aduancatering-module */[__webpack_require__.e("default~aduancatering-aduancatering-module~aduanhk-aduanhk-module~aduanlaundry-aduanlaundry-module"), __webpack_require__.e("aduancatering-aduancatering-module")]).then(__webpack_require__.bind(null, /*! ./aduancatering/aduancatering.module */ "./src/app/aduancatering/aduancatering.module.ts")).then(m => m.AduancateringPageModule)
    },
    {
        path: 'housekeeping',
        loadChildren: () => __webpack_require__.e(/*! import() | housekeeping-housekeeping-module */ "housekeeping-housekeeping-module").then(__webpack_require__.bind(null, /*! ./housekeeping/housekeeping.module */ "./src/app/housekeeping/housekeeping.module.ts")).then(m => m.HousekeepingPageModule)
    },
    {
        path: 'tugashk',
        loadChildren: () => __webpack_require__.e(/*! import() | tugashk-tugashk-module */ "tugashk-tugashk-module").then(__webpack_require__.bind(null, /*! ./tugashk/tugashk.module */ "./src/app/tugashk/tugashk.module.ts")).then(m => m.TugashkPageModule)
    },
    {
        path: 'maintenance',
        loadChildren: () => __webpack_require__.e(/*! import() | maintenance-maintenance-module */ "maintenance-maintenance-module").then(__webpack_require__.bind(null, /*! ./maintenance/maintenance.module */ "./src/app/maintenance/maintenance.module.ts")).then(m => m.MaintenancePageModule)
    },
    {
        path: 'tgsmaintenance',
        loadChildren: () => __webpack_require__.e(/*! import() | tgsmaintenance-tgsmaintenance-module */ "tgsmaintenance-tgsmaintenance-module").then(__webpack_require__.bind(null, /*! ./tgsmaintenance/tgsmaintenance.module */ "./src/app/tgsmaintenance/tgsmaintenance.module.ts")).then(m => m.TgsmaintenancePageModule)
    },
];
...
let AppComponent = class AppComponent {
    constructor(platform, splashScreen, statusBar, serviceService, navCtrl, router, util) {
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        ...
        imports: [
            ...
            _register_register_module__WEBPACK_IMPORTED_MODULE_10__["RegisterPageModule"],
    ...
    ngOnInit() {
        this.FormRegister = this.formBuilder.group({
            ...
            Email: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"]('', _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].compose([
                _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required,
                _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].pattern('^[\\w]+(?:\\.[\\w])*@(?:[a-zA-Z0-9-]+\\.)+[a-zA-Z]{2,6}$')
            ])),
            NoHp: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"]('', _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].compose([
                _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required,
...
let ServiceService = class ServiceService {
    ...
    CekUser() {
        ...
        return this.http.get(this.API_URL + 'users/my', { headers: headers, observe: 'response' }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["timeout"])(8000), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(Data => {
            return Data;
        }));
    }
    //login
    loginApi(credentials, type) {
        ...
        return this.http.post(this.API_URL + type, credentials, { headers: headers, observe: 'response' }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(Data => {
    ...
    RegisterApi(credentials, type) {
        ...
        return this.http.post(this.API_URL + type, credentials, { headers: headers }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(Data => {
            this.DataLogin = Data;
    ...
    submitaduan(form, url) {
        ...
        return this.http.post(this.API_URL + url, form, { headers: headers, observe: 'response' }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(Data => {
            this.DataLogin = Data;
...
module.exports = __webpack_require__(/*! C:\newasafinal\asaservandroid\src\main.ts */"./src/main.ts");
